...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "brccli",
		Short: "Command line interface for interacting with BRC blockchain daemon (server)",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of BRC node")
	...
	executor := cli.PrepareMainCmd(rootCmd, "BRC", app.DefaultCLIHome)
